...
public abstract class Gate extends NonObstacle implements Drawable {
    ...
    // Gate block
    public static abstract class GateBlock extends Amenity.AmenityBlock {
        ...
        public static abstract class GateBlockFactory extends Amenity.AmenityBlock.AmenityBlockFactory {
            public abstract Gate.GateBlock create(
                    Patch patch,
                    boolean attractor,
                    boolean spawner,
                    boolean hasGraphic,
