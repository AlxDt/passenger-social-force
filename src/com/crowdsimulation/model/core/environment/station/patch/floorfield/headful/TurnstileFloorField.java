...
public class TurnstileFloorField extends QueueingFloorField {
    ...
    public static TurnstileFloorField.TurnstileFloorFieldFactory turnstileFloorFieldFactory;

    static {
        turnstileFloorFieldFactory = new TurnstileFloorField.TurnstileFloorFieldFactory();
    }

    public static boolean registerPatch(
            Patch patch,
            Turnstile target,
            QueueingFloorField.FloorFieldState queueingFloorFieldState,
            double value) {
