...
public class TicketBooth extends Goal {
    ...
    // Ticket booth block
    public static class TicketBoothBlock extends Amenity.AmenityBlock {
        public static TicketBooth.TicketBoothBlock.TicketBoothBlockFactory ticketBoothBlockFactory;

        static {
            ticketBoothBlockFactory = new TicketBooth.TicketBoothBlock.TicketBoothBlockFactory();
        }
        ...
        public static class TicketBoothBlockFactory extends Amenity.AmenityBlock.AmenityBlockFactory {
            @Override
